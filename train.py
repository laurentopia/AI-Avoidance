...
base_model=keras.applications.mobilenet.MobileNet(input_shape=(224, 224, 3), alpha = 0.75,depth_multiplier = 1, dropout = 0.001, pooling='avg',include_top = False, weights = "imagenet")#was classes=1000
x=base_model.output
x = Dropout(0.001, name='dropout')(x)  #drop=0.001
x=Dense(512,activation='relu')(x) #funnel down with dense layer so the model can learn better
